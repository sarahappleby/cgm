...
ax[0].annotate('All', xy=(0.85, 0.9), xycoords='axes fraction',size=16,bbox=dict(boxstyle="round", fc="w"))
ax[1].annotate('SF', xy=(0.85, 0.9), xycoords='axes fraction',size=16,bbox=dict(boxstyle="round", fc="w"))
ax[2].annotate('Q', xy=(0.9, 0.9), xycoords='axes fraction',size=16,bbox=dict(boxstyle="round", fc="w"))
for i in range(3):
