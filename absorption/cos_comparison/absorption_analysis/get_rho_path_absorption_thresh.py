...
if __name__ == '__main__':
    ...
    if r200_scaled:
        ...
        cos_file = basic_dir+'data/cos_'+survey+'_obs_path_abs_thresh_data_scaled.h5'
        sim_file = basic_dir+'data/cos_'+survey+'_'+model+'_'+wind+'_'+snap+'_'+background+'_sim_path_abs_thresh_data_scaled.h5'
    else:
        cos_dict_orig['dist'] = cos_dict_orig['rho'].copy()
        cos_file = basic_dir+'data/cos_'+survey+'_obs_path_abs_thresh_data.h5'
        sim_file = basic_dir+'data/cos_'+survey+'_'+model+'_'+wind+'_'+snap+'_'+background+'_sim_path_abs_thresh_data.h5'
