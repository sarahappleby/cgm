...
if __name__ == '__main__':
    ...
    fg20_halos_file = '/home/sapple/cgm/absorption_analysis/data/cos_halos_'+model+'_'+wind+'_137_uvb_fg20_sim_ew_med_data'+scale_str+'.h5'
    fg20_halos_plot_dict = read_dict_from_h5(fg20_halos_file)
    fg20_dwarfs_file = '/home/sapple/cgm/absorption_analysis/data/cos_dwarfs_'+model+'_'+wind+'_151_uvb_fg20_sim_ew_med_data'+scale_str+'.h5'
