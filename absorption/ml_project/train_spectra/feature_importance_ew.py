...
if __name__ == '__main__':
    ...
    features_pretty = [r'${\rm log\ EW}_{\rm HI}$', r'${\rm log\ EW}_{\rm MgII}$', r'${\rm log\ EW}_{\rm CII}$',
                       r'${\rm log\ EW}_{\rm SiIII}$', r'${\rm log\ EW}_{\rm CIV}$', r'${\rm log\ EW}_{\rm OVI}$',
                       r'$f_{r200}$', r'${\rm log} M_\star$',
