...
if __name__ == '__main__':
    ...
    wind = sys.argv[2]
    snap = sys.argv[3]
    uvb = sys.argv[4] # can be 'uvb' or 'no_uvb'
    minT = sys.argv[5] # can be 4.0, 4.5, 5.0, 5.5
    ...
    spectra_dir = f'/disk04/sapple/cgm/absorption/ml_project/data/collisional/{uvb}/{model}_{wind}_{snap}_minT_{minT}/'
    ...
    for line in lines:
        ...
        results_file = f'/disk04/sapple/cgm/absorption/ml_project/data/collisional/results/{model}_{wind}_{snap}_{uvb}_minT_{minT}_ew_{line}.h5'
