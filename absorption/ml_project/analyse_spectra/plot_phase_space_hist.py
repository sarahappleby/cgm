...
if __name__ == '__main__':
    ...
    for line in lines:
        ...
        ax[i][j].step(delta_rho_bins[:-1] + delta_rho_bins[1] - delta_rho_bins[0], delta_rho_hist, c=ssfr_colors[0], lw=1, ls=rho_ls[0])
        ...
        for k in range(len(inner_outer)):
            ...
            ax[i][j].hist(all_delta_rho[sf_mask], bins=delta_rho_bins, density=True, color=ssfr_colors[1], ls=rho_ls[k], lw=1, histtype='step')
            ax[i][j].hist(all_delta_rho[gv_mask], bins=delta_rho_bins, density=True, color=ssfr_colors[2], ls=rho_ls[k], lw=1, histtype='step')
            ax[i][j].hist(all_delta_rho[q_mask], bins=delta_rho_bins, density=True, color=ssfr_colors[3], ls=rho_ls[k], lw=1, histtype='step')
