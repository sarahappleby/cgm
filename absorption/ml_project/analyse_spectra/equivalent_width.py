...
if __name__ == '__main__':
    ...
    for line in lines:
        ...
        #results_file = f'/disk04/sapple/data/normal/results/{model}_{wind}_{snap}_ew_{line}.h5'
        results_file = f'/disk04/sapple/data/normal/results/{model}_{wind}_{snap}_ew_{line}_extras.h5'
