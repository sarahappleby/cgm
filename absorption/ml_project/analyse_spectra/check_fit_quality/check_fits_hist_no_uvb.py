...
if __name__ == '__main__':
    ...
    for i in range(len(lines)):
        ...
        results_file = f'/disk04/sapple/data/collisional/results/{model}_{wind}_{snap}_no_uvb_fit_lines_{lines[i]}.h5'
    ...
    plt.savefig(f'{plot_dir}{model}_{wind}_{snap}_no_uvb_chisq_hist.png')
    plt.close()
    ...
    plt.tight_layout()
    fig.subplots_adjust(wspace=0., hspace=0.)
    plt.savefig(f'{plot_dir}{model}_{wind}_{snap}_no_uvb_chisq_cum_hist.png')
    plt.close()
