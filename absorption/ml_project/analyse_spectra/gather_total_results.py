...
if __name__ == '__main__':
    ...
    ew_file = f'/disk04/sapple/data/normal/results/{model}_{wind}_{snap}_fit_ew_{line}.h5'
    chisq_file = f'/disk04/sapple/data/normal/results/{model}_{wind}_{snap}_fit_chisq_{line}.h5'
    N_file = f'/disk04/sapple/data/normal/results/{model}_{wind}_{snap}_fit_N_{line}.h5'
